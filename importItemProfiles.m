function itemprofiles = importItemProfiles(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ITEMPROFILES1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   ITEMPROFILES1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   itemprofiles1 = importfile('item_profiles1.csv', 2, 167957);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/26 11:24:30
