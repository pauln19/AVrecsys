...
%         [remainingItems, ~, ib] = intersect(n_interactionsPerItem(:,2),remainingItems,'stable');
%         remainingIndex = remainingIndex(ib);
% %         topRemainingItems = remainingItems(1:min(150,length(remainingItems)),1);
%         remainingItems = remainingItems(1:min(150,length(remainingItems)),1);
%         remainingIndex = ...
%         remainingIndex(1:min(150,length(remainingIndex)),1);
